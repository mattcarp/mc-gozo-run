...
final class GPXParser: NSObject, XMLParserDelegate {
    ...
    static func parse(url: URL) -> (trackPoints: [CLLocationCoordinate2D], kmMarkers: [KmMarker], waterStations: [WaterStation]) {
        ...
        return (parser.trackPoints, sorted, parser.waterStations)
    }
